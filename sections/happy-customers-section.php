                                ...
                                <div class="feedback border-bottom-hover">
                                    <div class="pic-container">
                                        <div class="pic-container-inner">
											<?php
											if ( ! empty( $image ) ) { ?>
                                                <img src="<?php echo esc_url( $image ); ?>" alt="<?php echo( ! empty( $title ) ? esc_attr( $title ) : esc_attr( 'Avatar', 'llorix-one-companion' ) ); ?>">
												<?php
											} else {
												$default_image = llorix_one_lite_get_file( '/images/clients/client-no-image.jpg' ); ?>
                                                <img src="<?php echo esc_url( $default_image ); ?>" alt="<?php esc_attr_e( 'Avatar', 'llorix-one-companion' ); ?>">
												<?php
											} ?>
                                        </div>
                                    </div>
